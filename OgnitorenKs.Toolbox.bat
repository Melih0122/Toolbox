...
echo  %R%[90mบ%R%[0m   %R%[32m 3%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Bask hizmetini %C%[0m                       %R%[90mบ%R%[0m
...
echo  %R%[90mบ%R%[0m  %R%[32m 11%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Tarayc hizmetleri%C%[0m                    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 12%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Kamera hizmetleri%C%[0m                      %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 13%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Insider hizmeti%C%[0m                        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 14%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Biyometrik hizmeti%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 15%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Kalem ve Dokunmatik hizmeti%C%[0m            %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 16%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Sistem Geri ykleme hizmeti%C%[0m            %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 17%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Sysmain (Hzl Getir)%C%[0m                  %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 18%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Hzl Balat (Hibernate)%C%[0m               %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 19%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Konum hizmeti%C%[0m                          %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 20%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Windows Media Player%C%[0m                   %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 21%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Hyper-V hizmeti%C%[0m                        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 22%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Xbox hizmetini%C%[0m                         %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 23%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Bitlocker Src ifreleme hizmeti%C%[0m     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m  %R%[32m 24%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Karma Gereklik hizmeti (VR)%C%[0m           %R%[90mบ%R%[0m
...
:serv.5.tarifeli
echo [%date% - %time%] ^| Kapatlan Hizmetleri Y”net ^| Tarifeli aงlar hizmeti %3. >> %Location%\Logs
...
:serv.9.akis
echo [%date% - %time%] ^| Kapatlan Hizmetleri Y”net ^| Ak deneyimi hizmeti %3. >> %Location%\Logs
...
:serv.18.hibernate
::Hzl balang
echo [%date% - %time%] ^| Kapatlan Hizmetleri Y”net ^| Hzl balang^(Hibernate^) hizmeti %3. >> %Location%\Logs
