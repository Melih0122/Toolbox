...
echo   %ESC%[90mบ%ESC%%ESC%[32m 10.%ESC%%RGB%[36m GOG Galaxy%RGB%[0m           %ESC%[90mบ%ESC%[0m %ESC%[32m 36.%ESC%%RGB%[36m Any Video Converter%RGB%[0m    %ESC%[90mบ%ESC%%ESC%[32m 62.%ESC%%RGB%[33m %RGB%[0m                            %ESC%[90mบ%ESC%[0m 
echo   %ESC%[90mบ%ESC%%ESC%[32m 11.%ESC%%RGB%[36m Uplay%RGB%[0m                %ESC%[90mบ%ESC%[0m %ESC%[32m 37.%ESC%%RGB%[33m Free Download Manager%RGB%[0m  %ESC%[90mบ%ESC%%ESC%[32m 63.%ESC%%RGB%[33m %RGB%[0m                            %ESC%[90mบ%ESC%[0m 
...
echo   %ESC%[90mบ%ESC%%ESC%[32m 21.%ESC%%RGB%[36m Libre Office%RGB%[0m         %ESC%[90mบ%ESC%[0m %ESC%[32m 47.%ESC%%RGB%[36m Wise Care 365%RGB%[0m          %ESC%[90mบ%ESC%%ESC%[32m 73.%ESC%%RGB%[36m %RGB%[0m                            %ESC%[90mบ%ESC%[0m 
...
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 1.%ESC%%RGB%[33m Bluetooth hizmetini %RGB%%RGB%[90m[A€]%RGB%[0m                    %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 2.%ESC%%RGB%[33m Yazc hizmetini %RGB%%RGB%[90m[A€]%RGB%[0m                       %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 3.%ESC%%RGB%[33m Bask hizmetini %RGB%%RGB%[90m[A€]%RGB%[0m                        %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 4.%ESC%%RGB%[33m Telefon hizmetini %RGB%%RGB%[90m[A€]%RGB%[0m                      %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 5.%ESC%%RGB%[33m Tarifeli aงlar %RGB%%RGB%[90m[A€]%RGB%[0m                        %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 6.%ESC%%RGB%[33m IP yardmcs (IPv6)%RGB%%RGB%[90m[A€]%RGB%[0m                    %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 7.%ESC%%RGB%[33m Mobil Etkin Nokta (Hotspot) %RGB%%RGB%[90m[A€]%RGB%[0m            %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 8.%ESC%%RGB%[33m Radyo ve Uak modu hizmetini %RGB%%RGB%[90m[A€]%RGB%[0m           %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m   %ESC%[32m 9.%ESC%%RGB%[33m Uzak Masast/Ak/Aง hizmetleri%RGB%%RGB%[90m[A€]%RGB%[0m        %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m  %ESC%[32m 10.%ESC%%RGB%[33m Windows imdi Baงlan(WPS) %RGB%%RGB%[90m[A€]%RGB%[0m              %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m  %ESC%[32m 11.%ESC%%RGB%[33m Tarayc hizmetlerini %RGB%%RGB%[90m[A€]%RGB%[0m                  %ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%[0m  %ESC%[32m 12.%ESC%%RGB%[33m Kamera hizmetlerini %RGB%%RGB%[90m[A€]%RGB%[0m                    %ESC%[90mบ%ESC%[0m
...
echo  %RGB%[96mUzak Masast/Ak hizmetleri alyor...%RGB%[0m 
...
echo  %ESC%[90mบ%ESC%%ESC%[1;97m%ESC%%ESC%[46m                   Wireless Password Cracker                 %ESC%[0m%ESC%[90mบ%ESC%[0m
echo  %ESC%[90mบ%ESC%%ESC%[1;97m%ESC%%ESC%[46m                          (Archley)                          %ESC%[0m%ESC%[90mบ%ESC%[0m
