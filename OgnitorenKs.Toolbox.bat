...
echo   %R%[90mº%R%[32m  1.%C%[37m All In One Runtimes%C%[0m  %R%[90mº%R%[0m %R%[32m 27.%C%[36m OpenShot%C%[0m               %R%[90mº%R%[0m          %R%[92m BONUS%R%[0m               %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  2.%C%[33m Discord%C%[0m              %R%[90mº%R%[0m %R%[32m 28.%C%[36m Shotcut%C%[0m                %R%[90mº%R%[32m 53.%C%[36m %editmenu%%C%[90m [M]%R%[0m         %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  3.%C%[33m Whatsapp%C%[0m             %R%[90mº%R%[0m %R%[32m 29.%C%[36m Krita%C%[0m                  %R%[90mº%R%[32m 54.%C%[33m Hizmetleri Y”net%C%[90m [M]%C%[0m        %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  4.%C%[33m Signal%C%[0m               %R%[90mº%R%[0m %R%[32m 30.%C%[36m Gimp%C%[0m                   %R%[90mº%R%[32m 55.%C%[33m ICO Fix%C%[0m                     %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  5.%C%[33m Telegram%C%[0m             %R%[90mº%R%[0m %R%[32m 31.%C%[36m OBS Studio%C%[0m             %R%[90mº%R%[32m 56.%C%[37m Windows Edit”r%C%[90m [M]%C%[0m          %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  6.%C%[33m Zoom%C%[0m                 %R%[90mº%R%[0m %R%[32m 32.%C%[36m ShareX%C%[0m                 %R%[90mº%R%[32m 57.%C%[33m Gncelleme Sonras Temizlik%C%[0m %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  7.%C%[36m EpicGames%C%[0m            %R%[90mº%R%[0m %R%[32m 33.%C%[36m Audacity%C%[0m               %R%[90mº%R%[32m 58.%C%[33m Sistem / Market Onar%C%[0m        %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  8.%C%[36m Steam%C%[0m                %R%[90mº%R%[0m %R%[32m 34.%C%[36m K-Lite Codec%C%[0m           %R%[90mº%R%[32m 59.%C%[33m PC Temizle%C%[0m                  %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m  9.%C%[36m GOG Galaxy%C%[0m           %R%[90mº%R%[0m %R%[32m 35.%C%[36m VLC Media Player%C%[0m       %R%[90mº%R%[32m 60.%C%[36m Appx Y”netici%C%[90m [APP]%C%[0m         %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 10.%C%[36m Uplay%C%[0m                %R%[90mº%R%[0m %R%[32m 36.%C%[36m Aimp%C%[0m                   %R%[90mº%R%[32m 61.%C%[36m Folder to ISO%C%[90m [APP]%C%[0m         %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 11.%C%[36m Origin%C%[0m               %R%[90mº%R%[0m %R%[32m 37.%C%[36m Any Video Converter%C%[0m    %R%[90mº%R%[32m 62.%C%[33m Fat32 to NTFS%C%[0m               %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 12.%C%[36m Cheat Engine%C%[0m         %R%[90mº%R%[0m %R%[32m 38.%C%[33m Free Download Manager%C%[0m  %R%[90mº%R%[32m 63.%C%[33m Ping ™l‡er%C%[90m [*]%C%[0m              %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 13.%C%[36m Wemod%C%[0m                %R%[90mº%R%[0m %R%[32m 39.%C%[33m ˜nt Download Manager%C%[0m   %R%[90mº%R%[32m 64.%C%[33m Lisans Y”netimi%C%[90m [M]%C%[0m         %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 14.%C%[33m Google Chrome%C%[0m        %R%[90mº%R%[0m %R%[32m 40.%C%[33m ByClick Downloader%C%[0m     %R%[90mº%R%[32m 65.%C%[33m Kullanc Hesap Y”netimi%C%[90m [M]%C%[0m %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 15.%C%[33m Mozilla Firefox%C%[0m      %R%[90mº%R%[0m %R%[32m 41.%C%[33m Qbittorrent%C%[0m            %R%[90mº%R%[32m 66.%C%[33m Sistem Hakknda%C%[90m [*]%C%[0m         %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 16.%C%[33m Brave%C%[0m                %R%[90mº%R%[0m %R%[32m 42.%C%[33m GlassWire%C%[0m              %R%[90mº%R%[32m 67.%C%[33m Wifi Crack%C%[0m                  %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m
R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 25.%C%[33m WinRAR%C%[0m               %R%[90mº%R%[0m %R%[32m 51.%C%[36m OpenShell%C%[0m              %R%[90mº%R%[32m 77.%C%[37m League Of Legends%C%[90m[EUW]%C%[0m      %R%[90mº%R%[0m
echo   %R%[90mº%R%[32m 26.%C%[36m Kdenlive%C%[0m             %R%[90mº%R%[0m %R%[32m 52.%C%[36m Everything%C%[0m             %R%[90mº%R%[32m 78.%C%[37m Valorant%C%[0m                    %R%[90mº%R%[0m
echo   %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
...
Dism /Online /Get-Capabilities /format:table | findstr /i "NetFX3~~~~" | findstr /i "installed" > NUL 2>&1
	if %errorlevel%==1 (Dism /Online /Enable-Feature /Featurename:NetFx3 /All /Quiet /NoRestart)

Dism /Online /Get-Features /format:table | findstr /i "IIS-ASPNET45" | findstr /i "Enabled" > NUL 2>&1
	if %errorlevel%==1 (Dism /Online /Enable-Feature /FeatureName:IIS-ASPNET45 /All /Quiet /NoRestart)

Dism /Online /Get-Features /format:table | findstr /i "DirectPlay" | findstr /i "Enabled" > NUL 2>&1
...
echo   %R%[1;97m%R%[42m                                 Simge hatas onarlyor...                                 %R%[0m
ie4uinit.exe -show
taskkill /f /im explorer.exe > NUL 2>&1
...
echo  %R%[90mº%R%[0m  %R%[32m 11%C%[90m[%C%[36mA%C%[90m/%C%[36mK%C%[90m]%R%[32m.%C%[33m Windows imdi Ba§lan(WPS) hizmeti%C%[0m      %R%[90mº%R%[0m
...
:: Bluetooth (AVCTP hizmeti) 
::  Ses, video denetim aktarm protokoldr.
%PowerRun% sc config "BthAvctpSvc" start= %3
%PowerRun% net %1 BthAvctpSvc
:: Bluetooth destek hizmeti
::  Bluetooth cihazlarn bulunmas ve iliŸkilendirmesini sa§lar.
%PowerRun% sc config "bthserv" start= %3
%PowerRun% net %1 bthserv
:: Bluetooth kullanc deste§i hizmeti
::  Kullanc oturumuyla Bluetooth ”zelliklerinin tam ‡alŸmasn sa§lar.
%PowerRun% sc config "BluetoothUserService" start= %3
%PowerRun% net %1 BluetoothUserService
:: Ses a§ ge‡idi hizmeti
::  Eller boŸta profilinin ses a§ ge‡idini destekler.
%PowerRun% sc config "BTAGService" start= %3
%PowerRun% net %1 BTAGService
::-------------------------------------------------------
...
::----------------------------------------------------------------------------------------------------------------------------------------------
::    A‡ = %1 : start  | %2 : demand    | %3 : 1  |  %4 : 0  | %~5 : Call :delete2  | %~6 : AllowGameDVR     | %7 : a‡lyor
:: Kapat = %1 : stop   | %2 : disabled  | %3 : 0  |  %4 : 2  | %~5 : Call :dword    | %~6 : AllowGameDVR 0   | %7 : kapatlyor
::----------------------------------------------------------------------------------------------------------------------------------------------
goto :eof
...
%PowerRun% RD /S /Q "%programfiles%\Windows Defender Advanced Threat Protection"
%PowerRun% RD /S /Q "%programfiles%\Windows Defender"
%PowerRun% RD /S /Q "%programfiles%\Windows Security"
%PowerRun% RD /S /Q "%programfiles(x86)%\Windows Security"
%PowerRun% RD /S /Q "%programfiles(x86)%\Windows Defender"
%PowerRun% RD /S /Q "%programfiles(x86)%\Windows Defender Advanced Threat Protection"
%PowerRun% RD /S /Q "%programdata%\Microsoft\Windows Security Health"
%PowerRun% RD /S /Q "%programdata%\Microsoft\Windows Defender Advanced Threat Protection"
%PowerRun% RD /S /Q "%programdata%\Microsoft\Windows Defender"
%PowerRun% RD /S /Q "%windir%\SystemApps\Microsoft.Windows.SecHealthUI_cw5n1h2txyewy"
:: Servisler
