...
Call :dword "HKLM\OG_NTUSER\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" "TaskbarDa" "0" & :: Widget ikonu kaldçrçlçyor...
...
Call :dword "HKLM\OG_SOFTWARE\Microsoft\Windows\Windows Error Reporting" /v "LoggingDisabled" 1 & :: Windows Hata Raporlama devre dçüç bçrakçlçyor...
Call :dword "HKLM\OG_SOFTWARE\Microsoft\Windows\Windows Error Reporting\Consent" "DefaultOverrideBehavior" 1 & :: Windows Hata Raporlama devre dçüç bçrakçlçyor...
Call :dword "HKLM\OG_SOFTWARE\Microsoft\Windows\Windows Error Reporting\Consent" "DefaultConsent" 0 & :: Windows Hata Raporlama devre dçüç bçrakçlçyor...
...
:: Cab dosyalarçnçn saß tçk seáeneklerine yÅkleme îzellßi ekler.
