...
- Windows ekran ölçeklendirme ayarı Toolbox'ın pencerini ayarını bozabiliyor. Sorunsuz kullanım için programı kullanırken ölçeklendirmenin devre dışı bırakılması gerekmekdir.
