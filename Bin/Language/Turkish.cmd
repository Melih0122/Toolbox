...
echo            %R%[90m│%R%[32m  7-%R%[33m Fat32 to NTFS%R%[90m [M]              │%R%[32m  14-%R%[33m Görev Çubuğu Özelleştirme        %R%[90m│%R%[0m
...
echo %R%[90m  uygulama isimlerini öğrenebilirsiniz.
echo %R%[90m  Boşluk bırakarak çoklu yazabilirsiniz.
goto :eof
...
:Service_Info
echo   %R%[90m█ = Kapalı ^| %R%[32m♦%R%[90m = Açık ^| %R%[31m█%R%[90m = Kaldırılmış ^| %R%[35m█%R%[90m = Uyumsuz Windows
goto :eof
:Service_Info_2
echo   %R%[90m█ = Kapalı ^| %R%[32m♦%R%[90m = Açık ^| %R%[35m█%R%[90m = Uyumsuz Windows
goto :eof
:Service_Menu_1
echo  %R%[90m┌─────────────────────────────────────────┬─────────────────────────────────────────┐%R%[0m
...
goto :eof
:Service_Menu_33
echo  %R%[90m│%R%[32m 32%DL% Disk Birleştirme (Defrag)    %R%[90m│%R%[32m X-%R%[37m Menü                                 %R%[90m│%R%[0m
goto :eof
...
:Extra_4
echo   ►%R%[32m Format Tarihi:%R%[37m %Value1%%R%[90m ^| %R%[32mSaat Dilimi:%R%[37m %Value2%%R%[90m ^|%R%[37m %DateDay% - %Value4%%R%[0m
goto :eof
...
:CheckOS_1
echo %R%[31m Win10 sistemde çalıştırılamaz%R%[0m
goto :eof

:CheckOS_2
echo %R%[31m Win11 sistemde çalıştırılamaz%R%[0m
goto :eof

:Taskbar_1
echo  %R%[90m┌───────────────────────────────────────────────────┐%R%[0m
echo  %R%[90m│%R%[92m             Görev Çubuğu Özelleştirme             %R%[90m│%R%[0m
echo  %R%[90m├───────────────────────────────────────────────────┤%R%[0m
goto :eof
:Taskbar_2
echo  %R%[90m│ %R%[32m 1%DR% Saat yanı simgeleri göster%R%[90m Win10       │%R%[0m
goto :eof
:Taskbar_3
echo  %R%[90m│ %R%[32m 2%DR% Bildirim Alanı%R%[90m Win10                   │%R%[0m
goto :eof
:Taskbar_4
echo  %R%[90m│ %R%[32m 3%DR% Görev Çubuğu Hava Durumu               %R%[90m│%R%[0m
goto :eof
:Taskbar_5
