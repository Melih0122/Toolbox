...
echo  º OGNITORENKS TOOLBOX v1.7 ^| USER: %registereduser% ^| PC-Name: %pcname%	
...
echo   %ESC%[90mº%ESC%[1;97m%ESC%%ESC%[100m OGNITORENKS TOOLBOX v1.7 %ESC%[0m%ESC%[90m ^|%ESC%%ESC%[32m USER:%ESC%%ESC%[37m %registereduser% %ESC%%ESC%[90m^|%ESC%%ESC%[32m PC-Name: %ESC%%ESC%[37m%pcname%%ESC%[0m	
...
echo   %ESC%[90mº%ESC%%ESC%[32m 16.%ESC%%RGB%[37m Blitz%RGB%[0m                %ESC%[90mº%ESC%[0m %ESC%[32m 42.%ESC%%RGB%[33m Hamachi%RGB%[0m                %ESC%[90mº%ESC%[0m                                 %ESC%[90mº%ESC%[0m
