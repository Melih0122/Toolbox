...
::   Legnica
::  ----------
:: 	   Windows Search ”nbelliงinin temizlenmesiyle ilgili komutlarn eklenmesi.
::
:: ==============================================================================================================================
...
::    Download ilemlerinin yapldง uygulamadr. Komut istemiyle alr.
...
echo  %R%[90mบ                                                         บ%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[41m             ! WARNING !           ! WARNING !           %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mบ                                                         บ%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[41m             Right-click, run as administrator           %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mบ                                                         บ%R%[0m
...
Find "OGNITORENKS TOOLBOX %version%" %Location%\Logs > NUL 2>&1
	if %errorlevel%==1 ((
						...
						echo  บ OS: %caption% ^| x%osarch% ^| %ImageBuild% ^| %isderleme% ^| Power: %powerr%
...
echo   %R%[90mบ%R%[32m OS:%R%[37m %caption% %R%[90m^|%R%[37m x%osarch% %R%[90m^|%R%[37m %ImageBuild% %R%[0m%R%[90m^|%R%[37m %isderleme% %R%[90m^|%R%[32m Power:%R%[37m %powerr%%R%[0m	
echo   %R%[90mฬออออออออออออออออออออออออออหอออออออออออออออออออออออออออออหอออออออออออออออออออออออออออออออออน%R%[0m
echo   %R%[90mบ%R%[32m  1.%C%[37m All In One Runtimes  %R%[90mบ%R%[32m  27.%C%[36m Kdenlive               %R%[90mบ%R%[0m          %R%[92m BONUS%R%[0m               %R%[90mบ%R%[0m
echo   %R%[90mบ%R%[32m  2.%C%[33m Discord              %R%[90mบ%R%[32m  28.%C%[36m OpenShot               %R%[90mบ%R%[32m 53.%C%[36m %editmenu%%C%[90m [M]         บ%R%[0m
echo   %R%[90mบ%R%[32m  3.%C%[33m Whatsapp             %R%[90mบ%R%[32m  29.%C%[36m Shotcut                %R%[90mบ%R%[32m 54.%C%[33m Service management%C%[90m [M]      บ%R%[0m
echo   %R%[90mบ%R%[32m  4.%C%[33m Signal               %R%[90mบ%R%[32m  30.%C%[36m Krita                  %R%[90mบ%R%[32m 55.%C%[33m Icon Fix                    %R%[90mบ%R%[0m
echo   %R%[90mบ%R%[32m  5.%C%[33m Telegram             %R%[90mบ%R%[32m  31.%C%[36m Gimp                   %R%[90mบ%R%[32m 56.%C%[37m Windows Editor%C%[90m [M]          บ%R%[0m
echo   %R%[90mบ%R%[32m  6.%C%[33m Zoom                 %R%[90mบ%R%[32m  32.%C%[36m OBS Studio             %R%[90mบ%R%[32m 57.%C%[33m Update After Clener         %R%[90mบ%R%[0m
echo   %R%[90mบ%R%[32m  7.%C%[36m EpicGames            %R%[90mบ%R%[32m  33.%C%[36m ShareX                 %R%[90mบ%R%[32m 58.%C%[33m Windows - Store Repair      %R%[90mบ%R%[0m
echo   %R%[90mบ%R%[32m  8.%C%[36m Steam                %R%[90mบ%R%[32m  34.%C%[36m Audacity               %R%[90mบ%R%[32m 59.%C%[33m PC Cleaner                  %R%[90mบ%R%[0m
echo   %R%[90mบ%R%[32m  9.%C%[36m GOG Galaxy           %R%[90mบ%R%[32m  35.%C%[36m K-Lite Codec           %R%[90mบ%R%[32m 60.%C%[36m Folder to ISO%C%[90m [APP]         บ%R%[0m
echo   %R%[90mบ%R%[32m 10.%C%[36m Uplay                %R%[90mบ%R%[32m  36.%C%[36m VLC Media Player       %R%[90mบ%R%[32m 61.%C%[36m Fat32 to NTFS               %R%[90mบ%R%[0m
echo   %R%[90mบ%R%[32m
R%[0m%R%[90mบ%R%[0m
echo   %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
...
echo  %R%[90mบ%R%[1;97m%R%[100m                 Service Management                %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ              %R%[32m%R%[0m:%R%[36mEnable       %R%[100m %R%[0m:%R%[36mDisable             %R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
::
set servalue=%R%[100m %R%[0m&FOR %%b in (BthAvctpSvc bthserv BluetoothUserService BTAGService) do (Call :serv.check "%%b")
echo  %R%[90mบ%R%[0m   %R%[32m 1%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Bluetooth service%C%[0m                    %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "Spooler"
echo  %R%[90mบ%R%[0m   %R%[32m 2%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Printer service%C%[0m                      %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&FOR %%b in (TapiSrv PhoneSvc) do (Call :serv.check "%%b")
echo  %R%[90mบ%R%[0m   %R%[32m 3%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Phone service%C%[0m                        %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "DusmSvc"
echo  %R%[90mบ%R%[0m   %R%[32m 4%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Data Usage service%C%[0m                   %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&FOR %%b in (iphlpsvc IpxlatCfgSvc) do (Call :serv.check "%%b")
echo  %R%[90mบ%R%[0m   %R%[32m 5%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m IP Helper (IPv6)%C%[0m                     %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&FOR %%b in (icssvc SharedAccess ALG) do (Call :serv.check "%%b")
echo  %R%[90mบ%R%[0m   %R%[32m 6%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Windows Mobile Hotspot%C%[0m               %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "RMSvc"
echo  %R%[90mบ%R%[0m   %R%[32m 7%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Radio Management Service%C%[0m             %R%[90mบ%R%[0m
::
...
echo  %R%[90mบ%R%[0m   %R%[32m 8%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Remote Desktop/Streaming/Network serv%C%[0m%R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "WSearch"
echo  %R%[90mบ%R%[0m   %R%[32m 9%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Windows Search%C%[0m                       %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "wcncsvc"
echo  %R%[90mบ%R%[0m  %R%[32m 10%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Windows Connect Now(WPS) service%C%[0m     %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&FOR %%b in (FrameServer WiaRpc StiSvc) do (Call :serv.check "%%b")
echo  %R%[90mบ%R%[0m  %R%[32m 11%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Scanner and Camera services%C%[0m          %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "wisvc"
echo  %R%[90mบ%R%[0m  %R%[32m 12%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Insider service%C%[0m                      %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "WbioSrvc"
echo  %R%[90mบ%R%[0m  %R%[32m 13%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Biometric service%C%[0m                    %R%[90mบ%R%[0m
::
...
echo  %R%[90mบ%R%[0m  %R%[32m 14%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Pen and Touch service%C%[0m                %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&FOR %%b in (SDRSVC VSS swprv wbengine fhsvc) do (Call :serv.check "%%b")
echo  %R%[90mบ%R%[0m  %R%[32m 15%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m System Restore service%C%[0m               %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "SysMain"
echo  %R%[90mบ%R%[0m  %R%[32m 16%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Sysmain Fast Fetch%C%[0m                   %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m
...
echo  %R%[90mบ%R%[0m  %R%[32m 17%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Quick Launch (Hibernate)%C%[0m             %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&FOR %%b in (lfsvc NaturalAuthentication) do (Call :serv.check "%%b")
echo  %R%[90mบ%R%[0m  %R%[32m 18%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Location Service%C%[0m                     %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&findstr /i "Hyper-V" %Logs%\servvalue.txt | findstr /i "Disabled" > NUL 2>&1
	if %errorlevel%==1 (set servalue=%R%[32m%R%[0m)
echo  %R%[90mบ%R%[0m  %R%[32m 19%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Hyper-V service%C%[0m                      %R%[90mบ%R%[0m
::
...
echo  %R%[90mบ%R%[0m  %R%[32m 20%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Xbox service%C%[0m                         %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Call :serv.check "BDESVC"
echo  %R%[90mบ%R%[0m  %R%[32m 21%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m BitLocker Drive Encryption Service%C%[0m   %R%[90mบ%R%[0m
::
...
echo  %R%[90mบ%R%[0m  %R%[32m 22%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Mixed Reality service (VR)%C%[0m           %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&reg query "HKLM\Software\Policies\Microsoft\Windows\DriverSearching" /v "SearchOrderConfig" | findstr /i 0x0 > NUL 2>&1
	if %errorlevel%==1 (set servalue=%R%[32m%R%[0m)
echo  %R%[90mบ%R%[0m  %R%[32m 23%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Driver Install/Update service%C%[0m        %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m&Powershell -command "Get-MMAgent | Select-Object MemoryCompression| FL" | findstr /i False > NUL 2>&1
	if %errorlevel%==1 (set servalue=%R%[32m%R%[0m)
echo  %R%[90mบ%R%[0m  %R%[32m 24%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Memory Compression service%C%[0m           %R%[90mบ%R%[0m
::
set servalue=%R%[100m %R%[0m
...
reg query "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\0cc5b647-c1df-4637-891a-dec35c318583" /v  "ValueMax" | findstr /i 0x0 > NUL 2>&1
	if %errorlevel%==1 (set servalue=%R%[32m%R%[0m)
echo  %R%[90mบ%R%[0m  %R%[32m 25%C%[90m[%C%[36mE%C%[90m/%C%[36mD%C%[90m]%R%[0m%servalue%%R%[90m -%C%[33m Core Parking (CPU Core Sleep Mode)%C%[0m   %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m        %R%[32m X.%R%[36m Menu%R%[0m                                   %R%[90mบ%R%[0m
...
:: Bluetooth (AVCTP hizmeti) | Bluetooth destek hizmeti | Bluetooth kullanc desteงi hizmeti \ Ses aง geidi hizmeti
...
:: Windows Mobil Etkin Nokta Hizmeti | Internet Baงlants Paylam (ICS) | Uygulama katman aง geidi hizmeti
...
:serv.7.ucakmodu
:: Windows 11'de aง simgesinde sorun yaanmamas iin hizmetin kapatlmas engellendi.
...
:: Windows Yedekleme ve Geri Ykleme hizmeti | Birim G”lge kopyas | Microsoft Yazlm G”lge Kopya Saงlaycs | Blok Dzeyinde Yedekleme Altyap Hizmeti | Dosya gemii hizmeti
...
:: Oyun DVR ve Yayn kullanc hizmeti | Xbox Accessory Management Service | Xbox Live Aง Hizmeti | Xbox Live Kimlik Doงrulama Y”neticisi | Xbox Live Oyun Kaydetme | Teslimat optimizasyonu
...
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Add%C%[0m                                         %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m Remove%C%[0m                                      %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m           CompactOS (Windows Compression)         %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m CompactOS %C%[90m[Enable]                          บ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m CompactOS %C%[90m[Disable]                         บ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m Choice :%C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m               Windows 11 Customize                %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Taskbar Size %C%[90m[Small/Big]%C%[0m                    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m Taskbar Location %C%[90m[Bottom/Upper]%C%[0m             %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 3.%C%[33m Taskbar Icon Position %C%[90m[Left/Middle]%C%[0m         %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 4.%C%[33m Right-Click Menu %C%[90m[Old/New]%C%[0m                  %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 5.%C%[33m Right-Click Terminal %C%[90m[Add/Remove]%C%[0m           %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 6.%C%[33m Right-Click Take Ownership %C%[90m[Add/Removed]%C%[0m    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 7.%C%[33m CompactOS (Compression) %C%[90m[Enable/Disable]%C%[0m    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 8.%C%[33m Gpedit.msc (Local Group policy)%C%[90m[Add]%C%[0m        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 9.%C%[33m Postpone Windows Updates to 2050%C%[0m            %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m               Taskbar Size Setting                %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 0.%C%[33m Small %C%[0m                                      %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Default %C%[0m                                    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m Big %C%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m              Taskbar Location Setting             %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Bottom%C%[0m                                      %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 3.%C%[33m Upper%C%[0m                                       %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                  %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m Choice : %C%[0m
	if %value%==x goto win11settingsmenu
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m           Taskbar Icon Location Setting           %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 0.%C%[33m Left%C%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Middle%C%[0m                                      %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m Choice : %C%[0m
	if %value%==x goto Win11SettingsMenu
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m              Right-Click Menu Setting             %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Old%C%[0m                                         %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m New%C%[0m                                         %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m           Right-Click Terminal Setting            %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Terminal%C%[90m [Removed]%C%[0m                          %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m Terminal%C%[90m [Add]%C%[0m                              %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m               Windows 10 Customize                %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Taskbar Notification area icons%C%[90m [Show/Hide]%C%[0m %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m Notification area%C%[90m [Show/Hide]%C%[0m               %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 3.%C%[33m Take Ownership%C%[90m [Add/Removed]%C%[0m                %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 4.%C%[33m Taskbar Weather%C%[90m [Show/Hide]%C%[0m                 %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 5.%C%[33m Microsoft Store%C%[90m [ReInstall/Remove]%C%[0m          %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 6.%C%[33m CompactOS (Compression)%C%[90m [Enable/Disable]%C%[0m    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 7.%C%[33m Gpedit.msc (Local Group policy)%C%[90m [Add]%C%[0m       %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 8.%C%[33m Icon Change%C%[90m [Old/New]%C%[0m                       %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 9.%C%[33m Postpone Windows Updates to 2050%C%[0m            %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Main Menu%R%[0m                                   %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m         Taskbar Notification area icons           %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 0.%C%[33m Show all%C%[90m [Enable]%C%[0m                           %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Hide all%C%[90m [Disable]%C%[0m                          %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m             Notification Area Setting             %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 0.%C%[33m Enable%C%[0m                                      %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Disable%C%[0m                                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m  Choice : %C%[0m
	if %value%==x goto Win10SettingsMenu
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m           Taskbar Weather Setting                 %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 0.%C%[33m Hide%C%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Show%C%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value= %C%[92m  Choice : %C%[0m
	if %value%==x goto Win10SettingsMenu
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m              Microsoft Store Management           %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Microsoft Store%C%[90m [Remove]%C%[0m                    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m Microsoft Store%C%[90m [Re-Install]%C%[0m                %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m                  Icon Management                  %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Old ICO%C%[90m [Install]%C%[0m                           %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m New ICO%C%[90m [Install]%C%[0m                           %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Menu%R%[0m                                        %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  Choice : %C%[0m
...
echo 
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m              User Account Management              %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 1.%C%[33m Administrator%C%[90m [Enable]%C%[0m                      %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 2.%C%[33m Administrator%C%[90m [Disable]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 3.%C%[33m Add user to Admin group%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 4.%C%[33m User%C%[90m [Add]%C%[0m                                  %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 5.%C%[33m User%C%[90m [Delete]%C%[0m                               %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 6.%C%[33m Forgot password - Change%C%[0m                    %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m 7.%C%[33m Show Current Users%C%[0m                          %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m   %R%[32m X.%R%[36m Main Menu%R%[0m                                   %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m Choice : %C%[0m
...
echo 
echo   %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo   %R%[90mบ%R%[1;97m%R%[100m            Administrator activating             %R%[0m%R%[90mบ%R%[0m
echo   %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
...
echo 
echo   %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo   %R%[90mบ%R%[1;97m%R%[100m            Administrator disabling              %R%[0m%R%[90mบ%R%[0m
echo   %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
...
echo 
echo   %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo   %R%[90mบ%R%[1;97m%R%[100m             Add User to Admin Group             %R%[0m%R%[90mบ%R%[0m
echo   %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
...
echo 
echo   %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo   %R%[90mบ%R%[1;97m%R%[100m                  New User Add                   %R%[0m%R%[90mบ%R%[0m
echo   %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  User Name : %C%[0m
	if %value%==x GOTO AdminMenu
	if %value%==X GOTO AdminMenu
...
echo 
echo   %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo   %R%[90mบ%R%[1;97m%R%[100m                   User Delete                   %R%[0m%R%[90mบ%R%[0m
echo   %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  User Name : %C%[0m
	if %value%==x GOTO AdminMenu
	if %value%==X GOTO AdminMenu
...
echo 
echo   %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo   %R%[90mบ%R%[1;97m%R%[100m              Forgot Password - Change           %R%[0m%R%[90mบ%R%[0m
echo   %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  User Name : %C%[0m
	if %value%==x GOTO AdminMenu
	if %value%==X GOTO AdminMenu
...
echo  %R%[90mษอออออออออออออออออออออออออออออออออออออออออออออออออออป%R%[0m
echo  %R%[90mบ%R%[1;97m%R%[100m            Automatic Computer Shutdown            %R%[0m%R%[90mบ%R%[0m
echo  %R%[90mฬอออออออออออออออออออออออออออออออออออออออออออออออออออน%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 0.%C%[33m 30%C%[90m [Minute]%C%[0m                   %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 1.%C%[33m  1%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 2.%C%[33m  2%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 3.%C%[33m  3%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 4.%C%[33m  4%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 5.%C%[33m  5%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 6.%C%[33m  6%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 7.%C%[33m  7%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 8.%C%[33m  8%C%[90m [Hour]%C%[0m                     %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m 9.%R%[33m Cancel%R%[0m                        %R%[90mบ%R%[0m
echo  %R%[90mบ%R%[0m                 %R%[32m X.%R%[36m Menu%R%[0m                          %R%[90mบ%R%[0m
echo  %R%[90mศอออออออออออออออออออออออออออออออออออออออออออออออออออผ%R%[0m
set /p value=%C%[92m  Choice : %C%[0m
...
:: --------------------------------------------------------------------------------------------
:: lerleme ubuงu konusunda yardmc olan KaanBeyhan'a teekkr ederim.
:: --------------------------------------------------------------------------------------------
:wget
ping -n 1 www.bing.com -w 20000 > NUL
	if %errorlevel%==1 (echo   %R%[1;97m%R%[41m                                   No Internet connection                                   %R%[0m
						echo [%date% - %time%] ^| wget ^| HATA! nternet baงlants yok. "%~2" / "%~1" / "%download%" >> %Location%\Logs
...
ping -n 1 www.bing.com -w 20000 > NUL
	if %errorlevel%==1 (echo   %R%[1;97m%R%[41m                                   No Internet connection                                   %R%[0m
						echo [%date% - %time%] ^| wget2 ^| HATA! nternet baงlants yok. "%~2" / "%~1" / "%download%" >> %Location%\Logs
						timeout /t 4 /nobreak > NUL
						goto :eof)
...
ping -n 1 www.bing.com -w 20000 > NUL
	if %errorlevel%==1 (echo   %R%[1;97m%R%[41m                                   No Internet connection                                   %R%[0m
						echo [%date% - %time%] ^| wget3 ^| HATA! nternet baงlants yok. "%~2" / "%~1" >> %Location%\Logs
						timeout /t 4 /nobreak > NUL
						goto :eof)
...
ping -n 1 www.bing.com -w 20000 > NUL
	if %errorlevel%==1 (echo   %R%[1;97m%R%[41m                                   No Internet connection                                   %R%[0m
						...
						Call :Logss "wgetyok" "HATA! nternet baงlants olmadง iin wget.exe indirilemedi."
