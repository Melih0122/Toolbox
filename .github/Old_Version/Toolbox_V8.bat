...
:: ==============================================================================================================================
::                                          NOTLAR
::  > Stremio uygulamas sorunlu ‡alŸyor.
::  > Notepad gncel srm ‡ktk‡a indirmelerde sorun ‡karyor.  
::
::
::
:: ==============================================================================================================================
...
echo   %ESC%[35m^|%ESC%%ESC%[107m OGNITORENKS TOOLBOX %ESC%[0m%ESC%[35m^|%ESC%%ESC%[32m USER:%ESC%%ESC%[37m %registereduser% %ESC%%ESC%[35m^|%ESC%%ESC%[32m PC-Name: %ESC%%ESC%[37m%pcname%%ESC%[0m	
echo   %ESC%[35m^|%ESC%%ESC%[32m OS:%ESC%%ESC%[37m %caption% %ESC%%ESC%[35m^|%ESC%%ESC%[37m x%osarch% %ESC%%ESC%[35m^|%ESC%%ESC%[37m %ImageBuild% %ESC%[0m%ESC%[35m^|%ESC%%ESC%[37m %buildnumber%%ESC%%ESC%[35m^|%ESC%%ESC%[32m G‡:%ESC%%ESC%[37m %gucc% %ESC%[0m	
echo   %ESC%[35m^|%ESC%%ESC%[35m%ESC%%ESC%[35m^|%ESC%[0m
echo   %ESC%[35m^|%ESC%%ESC%[32m  1.%ESC%%ESC%[37m All ˜n One Runtimes%ESC%[0m  ^| %ESC%[32m 27.%ESC%%ESC%[36m Kdenlive%ESC%[0m               %ESC%[35m^|%ESC%[0m          %ESC%[92m BONUS%ESC%[0m               %ESC%[35m^|%ESC%[0m  
echo   %ESC%[35m^|%ESC%%ESC%[32m  2.%ESC%%ESC%[33m Discord%ESC%[0m              ^| %ESC%[32m 28.%ESC%%ESC%[36m Krita%ESC%[0m                  %ESC%[35m^|%ESC%%ESC%[32m 53.%ESC%%ESC%[93m Windows 10 Edit%ESC%[0m             %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m  3.%ESC%%ESC%[33m Whatsapp%ESC%[0m             ^| %ESC%[32m 29.%ESC%%ESC%[36m Gimp%ESC%[0m                   %ESC%[35m^|%ESC%%ESC%[32m 54.%ESC%%ESC%[93m Windows 11 Edit%ESC%[0m             %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m  4.%ESC%%ESC%[33m Signal%ESC%[0m               ^| %ESC%[32m 30.%ESC%%ESC%[36m OBS Studio%ESC%[0m             %ESC%[35m^|%ESC%%ESC%[32m 55.%ESC%%ESC%[33m Gncelleme Sonras%ESC%[0m          %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m  5.%ESC%%ESC%[33m Telegram%ESC%[0m             ^| %ESC%[32m 31.%ESC%%ESC%[36m LightShoot%ESC%[0m             %ESC%[35m^|%ESC%%ESC%[32m 56.%ESC%%ESC%[33m Sistem/Market Onar%ESC%[0m          %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m  6.%ESC%%ESC%[33m Microsoft Teams%ESC%[0m      ^| %ESC%[32m 32.%ESC%%ESC%[36m Audacity%ESC%[0m               %ESC%[35m^|%ESC%%ESC%[32m 57.%ESC%%ESC%[33m PC Temizle%ESC%[0m                  %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m  7.%ESC%%ESC%[33m Skype%ESC%[0m                ^| %ESC%[32m 33.%ESC%%ESC%[36m K-Lite Codec%ESC%[0m           %ESC%[35m^|%ESC%%ESC%[32m 58.%ESC%%ESC%[33m Appx Y”netici%ESC%[0m               %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m  8.%ESC%%ESC%[36m EpicGames%ESC%[0m            ^| %ESC%[32m 34.%ESC%%ESC%[36m VLC Media Player%ESC%[0m       %ESC%[35m^|%ESC%%ESC%[32m 59.%ESC%%ESC%[33m Folder to ISO%ESC%[0m               %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m  9.%ESC%%ESC%[36m Steam%ESC%[0m                ^| %ESC%[32m 35.%ESC%%ESC%[36m Aimp%ESC%[0m                   %ESC%[35m^|%ESC%%ESC%[32m 60.%ESC%%ESC%[33m Fat32 to NTFS%ESC%[0m               %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 10.%ESC%%ESC%[36m GOG Galaxy%ESC%[0m           ^| %ESC%[32m 36.%ESC%%ESC%[36m Format Factory%ESC%[0m         %ESC%[35m^|%ESC%%ESC%[32m 61.%ESC%%ESC%[33m Sistem Hakknda%ESC%[0m             %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 11.%ESC%%ESC%[36m Uplay%ESC%[0m                ^| %ESC%[32m 37.%ESC%%ESC%[33m Free Download Manager%ESC%[0m  %ESC%[35m^|%ESC%%ESC%[32m 62.%ESC%%ESC%[33m Lisans Durumu%ESC%[0m               %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 12.%ESC%%ESC%[36m Origin%ESC%[0m               ^| %ESC%[32m 38.%ESC%%ESC%[33m EagleGet%ESC%[0m               %ESC%[35m^|%ESC%%ESC%[32m 63.%ESC%%ESC%[33m Ping ™l‡er%ESC%[0m                  %ESC%[35m^|%ESC%[0m  
echo   %ESC%[35m^|%ESC%%ESC%[32m 13.%ESC%%ESC%[36m Cheat Engine%ESC%[0m         ^| %ESC%[32m 39.%ESC%%ESC%[33m ByClick Downloader%ESC%[0m     %ESC%[35m^|%ESC%%ESC%[32m 64.%ESC%%ESC%[33m Kullanc Hesap Y”netimi%ESC%[0m     %ESC%[35m^|%ESC%[0m
echo   %ESC%[35m^|%ESC%%ESC%[32m 14.%ESC%%ESC%[36m Wemod%ESC%[0m                ^| %ESC%[32m 40.%ESC%%ESC%[33m Utorrent%ESC%[0m               %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m
echo   %ESC%[35m^|%ESC%%ESC%[32m 15.%ESC%%ESC%[37m League Of Legends%ESC%[0m    ^| %ESC%[32m 41.%ESC%%ESC%[33m GlassWire%ESC%[0m              %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 16.%ESC%%ESC%[37m Blitz%ESC%[0m                ^| %ESC%[32m 42.%ESC%%ESC%[33m TeamViewer%ESC%[0m             %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m
echo   %ESC%[35m^|%ESC%%ESC%[32m 17.%ESC%%ESC%[33m Google Chrome%ESC%[0m        ^| %ESC%[32m 43.%ESC%%ESC%[33m Hamachi%ESC%[0m                %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m  
echo   %ESC%[35m^|%ESC%%ESC%[32m 18.%ESC%%ESC%[33m Mozilla Firefox%ESC%[0m      ^| %ESC%[32m 44.%ESC%%ESC%[33m Stremio%ESC%[0m                %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 19.%ESC%%ESC%[33m Brave%ESC%[0m                ^| %ESC%[32m 45.%ESC%%ESC%[36m MSI Afterburner%ESC%[0m        %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 20.%ESC%%ESC%[33m Microsoft Edge%ESC%[0m       ^| %ESC%[32m 46.%ESC%%ESC%[36m Hibit Uninstaller%ESC%[0m      %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 21.%ESC%%ESC%[36m Libre Office%ESC%[0m         ^| %ESC%[32m 47.%ESC%%ESC%[36m Unlocker%ESC%[0m               %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 22.%ESC%%ESC%[36m Adobe Reader%ESC%[0m         ^| %ESC%[32m 48.%ESC%%ESC%[36m OpenShell%ESC%[0m              %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 23.%ESC%%ESC%[36m Notepad++%ESC%[0m            ^| %ESC%[32m 49.%ESC%%ESC%[36m SSD Fresh%ESC%[0m              %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 24.%ESC%%ESC%[36m Calibre%ESC%[0m              ^| %ESC%[32m 50.%ESC%%ESC%[36m Everything%ESC%[0m             %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 25.%ESC%%ESC%[33m 7 - Zip%ESC%[0m              ^| %ESC%[32m 51.%ESC%%ESC%[36m TaskbarX%ESC%[0m               %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m 
echo   %ESC%[35m^|%ESC%%ESC%[32m 26.%ESC%%ESC%[33m WinRAR%ESC%[0m               ^| %ESC%[32m 52.%ESC%%ESC%[37m €oklu Se‡im Yap%ESC%[0m        %ESC%[35m^|%ESC%[0m                                 %ESC%[35m^|%ESC%[0m
echo   %ESC%[35m^|%ESC%[0m--------------------------------------------------------%ESC%[35m-%ESC%[0m---------------------------------%ESC%[35m^|%ESC%[0m
echo   %ESC%[35m^|%ESC%[0m                          %ESC%[92m 0.%ESC%%ESC%[31m Kalntlar temizleyerek kapat%ESC%[0m                              %ESC%[35m^|%ESC%[0m
echo   %ESC%[35m%ESC%[0m
set /p menu= %ESC%[92m  Yapmak istedi§iniz iŸlem : %ESC%[0m
	...
	if %menu%==55 (Call :UpdateAfter)
	if %menu%==56 (Call :WindowsRepair)
	if %menu%==57 (Call :PCTemizle)
	if %menu%==58 (Call :AppxManager)
	if %menu%==59 (Call :FoldertoISO)
	if %menu%==60 (Call :Fat32toNTFS)
	if %menu%==61 (Call :SistemHakkinda)
	if %menu%==62 GOTO Slmgrvbs
...
:Download19
:Brave
Call :wget "https://brave-browser-downloads.s3.brave.com/latest/brave_installer-x64.exe" Brave.exe "--install --silent --system-level"
REM UBlock Origin
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Google\Chrome\Extensions\cjpalhdlnbpafiamejdnhcphjbkeiagm" /v "update_url" /t REG_SZ /d "https://clients2.google.com/service/update2/crx" /f > NUL 2>&1
REM HTTPS Everywhere
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Google\Chrome\Extensions\gcbommkclmclpchllfjekcdonpmejbdp" /v "update_url" /t REG_SZ /d "https://clients2.google.com/service/update2/crx" /f > NUL 2>&1
...
Call :wget "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.1.9.2/npp.8.1.9.2.Installer.x64.exe" Notepad.exe /S
goto :eof
...
Call :wget "https://artfiles.org/gimp.org/pub/gimp/v2.10/windows/gimp-2.10.28-setup.exe" Gimp.exe "/VERYSILENT /NORESTART /MERGETASKS=desktopicon /ALLUSERS"
goto :eof
...
Call :wget "https://github.com/audacity/audacity/releases/download/Audacity-3.0.5/audacity-win-3.0.5-64bit.exe" Audacity.exe "/VERYSILENT /NORESTART"
goto :eof
...
echo        %ESC%[92m 7.%ESC%%ESC%[37m Compact OS%ESC%[0m
...
echo        %ESC%[92m 5.%ESC%%ESC%[37m Compact OS%ESC%[0m
echo        %ESC%[92m 6.%ESC%%ESC%[33m Ana men%ESC%[0m
echo  %ESC%[35m=====================================================%ESC%[0m
set /p deger=%ESC%[92m  ˜Ÿlem : %ESC%[0m
