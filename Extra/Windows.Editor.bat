...
echo  %R%[90mº   %R%[32m 4.%C%[33m ESD to WIM%C%%C%[90m [D™NšžTšR]%C%[0m                     %R%[90mº%R%[0m
echo  %R%[90mº   %R%[32m 5.%C%[33m WIM /Delete%C%%C%[90m [S˜L]%C%[0m                         %R%[90mº%R%[0m
echo  %R%[90mº   %R%[32m 6.%C%[33m WIM Mount%C%%C%[90m [YšKLE]%C%[0m                         %R%[90mº%R%[0m
echo  %R%[90mº   %R%[32m 7.%C%[33m WIM Remount%C%%C%[90m [YEN˜DEN YšKLE]%C%[0m               %R%[90mº%R%[0m
echo  %R%[90mº   %R%[32m 8.%C%[33m WIM Unmount%C%%C%[90m [TOPLA]%C%[0m                       %R%[90mº%R%[0m
echo  %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
echo  %R%[90mº   %R%[36m 9.%C%[33m Regedit%C%%C%[90m [YšKLE]%C%[0m                           %R%[90mº%R%[0m
echo  %R%[90mº  %R%[32m 10.%C%[33m Regedit%C%%C%[90m [TOPLA]%C%[0m                           %R%[90mº%R%[0m 
echo  %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
echo  %R%[90mº  %R%[32m 11.%C%[33m Dism Update%C%%C%[90m [ONLINE]%C%[0m                      %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 12.%C%[33m Dism Update%C%%C%[90m [OFFLINE]%C%[0m                     %R%[90mº%R%[0m
echo  %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
echo  %R%[90mº  %R%[36m 13.%C%[33m Appx ykleyici%C%%C%[90m [OFFLINE]%C%[0m                  %R%[90mº%R%[0m
echo  %R%[90mº  %R%[32m 14.%C%[33m Appx ykleyici%C%%C%[90m [ONLINE]%C%[0m                   %R%[90mº%R%[0m
echo  %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
echo  %R%[90mº  %R%[32m 15.%C%[33m Driver Yedekle%C%%C%[90m [ONLINE]%C%[0m                   %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 16.%C%[33m Driver Ykle%C%%C%[90m [OFFLINE]%C%[0m                    %R%[90mº%R%[0m
echo  %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
echo  %R%[90mº  %R%[32m 17.%C%[33m Setup Dzenle%C%%C%[90m [OFFLINE]%C%[0m                   %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 18.%C%[33m Yeni Simgeleri ykle%C%%C%[90m [OFFLINE]%C%[0m            %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 19.%C%[33m Walpaper De§iŸtir%C%%C%[90m [OFFLINE]%C%[0m               %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 20.%C%[33m Telemetry engelle (Hosts)%C%%C%[90m[OFFLINE]%C%[0m        %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 21.%C%[33m OneDrive Sil %C%%C%[90m[OFFLINE]%C%[0m                    %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 22.%C%[33m Gpedit.msc ekle%C%%C%[90m[OFFLINE]%C%[0m                  %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 23.%C%[33m Hyper-V ekle%C%%C%[90m[OFFLINE]%C%[0m                     %R%[90mº%R%[0m
echo  %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
echo  %R%[90mº  %R%[36m 24.%C%[33m Katlmsz program ve ayar ekle %C%%C%[90m[OFFLINE]%C%[0m %R%[90mº%R%[0m
echo  %R%[90mº  %R%[36m 25.%C%[33m Katlmsz program ve ayar ekle %C%%C%[90m[ONLINE]%C%[0m  %R%[90mº%R%[0m
echo  %R%[90mÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹%R%[0m
...
Find /C /I "\\" %Location%\Edit\Logs\Slash.txt > NUL
	if %errorlevel%==0 (echo %R%[91m HATA! ISO dosyas ba§lanamaz.
						...
						echo [%date% - %time%] ^| degisken4 ^| HATA! ^> ISO kalb ba§lanmaya ‡alŸt. MerkezWim=%MerkezWim% >> %Location%\logs
						timeout /t 5 /nobreak > NUL
						goto WindowsEditMenu)
Find "boot.wim" %Location%\Edit\Logs\Slash.txt > NUL
	if %errorlevel%==0 (DEL /F /Q /A "%Location%\Edit\Logs\Slash.txt" > NUL
